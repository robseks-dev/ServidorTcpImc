package robertoberrio.imc.modelo;
    ...
    public Imc getImc() {
        ...
        if (peso <= 0 || altura <= 0) {
            ...
            if (imc.resultado < 18.5) {
                imc.mensaje = "Debes consultar con un médico, tu peso es muy bajo.";
            } else if (imc.resultado >= 18.5 && imc.resultado <= 24.9) {
                imc.mensaje = "Estas bien de peso.";
            } else if (imc.resultado > 24.9 && imc.resultado <= 29.9) {
                imc.mensaje = "Debes bajar de peso.";
            } else {
                imc.mensaje = "Debes consultar con un médico, tu peso es muy alto.";
            }
